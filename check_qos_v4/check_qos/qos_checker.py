...
# ────────── 규칙 ──────────
RULES = [
    (rule_durability_needs_rel, "Critical"),#27
    #(rule_durability_exclusive, "Warn"),
    #(rule_dstorder_requires_rel_dur, "Warn"),
    (rule_deadline_vs_durability, "Incidental"),#40
    ...
    (rule_lease_vs_deadline, "Conditional"),#33
    #(rule_deadline_with_best_effort, "Warn"),
    (rule_exclusive_best_effort_deadline, "Conditional"),#31, 32
    (rule_autodispose_with_best_effort, "Conditional"),#37
    (rule_lifespan_vs_deadline, "Critical"),#41
    #(rule_history_vs_lifespan, "Warn"),
    #(rule_exclusive_with_deadline, "Warn"),
    #(rule_buffer_capacity_vs_lifespan, "Warn"),
    (rule_dest_order_vs_depth, "Conditional"), #3
    #(rule_keep_last_depth_positive, "Warn"),
    (rule_history_vs_max_per_instance, "Critical"),#1
    #(rule_best_effort_exclusive, "Warn"),
    #(rule_announce_vs_lease, "Warn"),
    (rule_autoenable_vs_volatile_reader, "Incidental"),#6
    (rule_max_samples_vs_per_instance, "Critical"),#2
    (rule_destorder_keepall_mpi, "Conditional"), #4
    (rule_rdlife_autopurge_vs_durability, "Incidental"),#5
    (rule_liveliness_manual_partition, "Incidental"), #9
    (rule_autodispose_with_exclusive, "Incidental"), #10
    (rule_lifespan_too_short_for_durability, "Conditional"), #13
    (rule_exclusive_lease_infinite, "Conditional"),#17
    (rule_nowriter_delay_vs_infinite_lease, "Conditional"),#18
    (rule_reliable_keep_last_depth_too_small, "Conditional"),#28
    (rule_keepall_max_samples_per_instance, "Conditional"),#29
    (rule_lifespan_too_short_for_reliability, "Conditional"),#30
    (rule_best_effort_with_manual_liveliness, "Conditional"),#34
    (rule_deadline_too_short_for_exclusive, "Conditional"),#35
    (rule_lease_too_short_for_exclusive, "Conditional"),#36
    (rule_keepall_durable_instance_budget, "Conditional"),#12
    (rule_durable_keep_last_depth_1, "Conditional"),#11
    (rule_keepall_durable_instance_budget_1, "Conditional"), #39
    (rule_durable_keep_last_depth_2, "Conditional"),#38
    (rule_exclusive_deadline_infinite, "Conditional"),#16
    (rule_lifespan_exceeds_per_instance, "Conditional"),#15
    (rule_keep_last_lifespan_overflow, "Conditional"),#14
...
# ────────── 교차규칙 ──────────
CROSS_RULES = [
            (rule_dest_order_compat, "Critical"),#25
            (rule_ownership_compat, "Critical"), #24
            (rule_reliability_compat, "Critical"),#20
            (rule_durability_compat, "Critical"), #21
            (rule_deadline_period_compat, "Critical"), #22       # xml 2개
            #(rule_liveliness_compat, "Warn"),             # xml 2 + dict 2
            (rule_nowriter_autodispose_cross, "Conditional"), #26    # dict 2
            #(rule_partition_userdata_key, "Warn"),        # dict 2
            (rule_partition_overlap, "Critical"),  #19           # ★ xml 2개
            (rule_durable_partition_miss, "Incidental"),  #7      # xml 2 + dict 2
            (rule_deadline_partition_reset, "Incidental"), #8     # ★ xml 2개
            (rule_liveliness_incompatibility, "Critical"), #23
]
